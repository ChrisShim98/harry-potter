...
const Card = ({id, name, hogwartsHouse, image}) => {
  ...
  return (
    <div className="p-1 w-[47vw] border rounded-lg shadow-lg md:w-[25vw] lg:w-[20vw]">
      <div className="bg-white rounded-lg">
        ...
        />
        <div className="p-6">
          <h2 className="font-bold mb-2 sm:text-2xl md:text-xl lg:text-2xl 2xl:text-4xl font-harryp">
            {name}
          </h2>
