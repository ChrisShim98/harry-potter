  ...
  return (
    <div>
      ...
      <div className='py-[20vh] md:py-[25vh] px-[10vw] min-h-[85vh] sm:min-h-[87vh] lg:min-h-[80vh]'>
        ...
        <a href='https://github.com/fedeperin/harry-potter-api-english#harry-potter-api' target='_blank' rel='noreferrer' className='hover:text-red-600'> Github Link</a></h1>
