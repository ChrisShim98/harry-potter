    ...
    <div>
      ...
      <div className="py-[25vh] px-[10vw] min-h-[85vh] sm:min-h-[87vh] lg:min-h-[80vh]">
        ...
        <div className="flex justify-center">
          <a href='https://twitter.com/ChrisShim_' target='_blank' className="text-2xl sm:text-3xl px-[2vw] hover:text-red-600">
            <FaTwitter />
          </a>
          <a href='https://www.youtube.com/channel/UCild7pbBT8Zalh9s349rmrQ' target='_blank' className="text-2xl sm:text-3xl px-[2vw] hover:text-red-600">
            <FaYoutube />
          </a>
        </div>
